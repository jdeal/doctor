  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "FunctionParameter": parse_FunctionParameter,
      ...
      function parse_PropertyAssignment() {
        ...
        var savedPos4 = pos;
        var savedPos5 = pos;
        var result40 = parse_Pos();
        if (result40 !== null) {
          var result41 = parse_PropertyName();
          if (result41 !== null) {
            ...
            if (result42 !== null) {
              ...
              if (result43 !== null) {
                ...
                if (result44 !== null) {
                  var result45 = parse_AssignmentExpression();
                  if (result45 !== null) {
                    var result38 = [result40, result41, result42, result43, result44, result45];
                  } else {
                    var result38 = null;
                    pos = savedPos5;
                  }
        ...
        var result39 = result38 !== null
          ? (function(p, name, value) {
              ...
              })(result38[0], result38[1], result38[5])
          : null;
        if (result39 !== null) {
        ...
        if (result37 !== null) {
          ...
          var savedPos2 = pos;
          var savedPos3 = pos;
          var result23 = parse_Pos();
          if (result23 !== null) {
            var result24 = parse_GetToken();
            if (result24 !== null) {
              var result25 = parse___();
              if (result25 !== null) {
                var result26 = parse_PropertyName();
                if (result26 !== null) {
                        ...
                        if (result30 !== null) {
                          ...
                          if (result31 !== null) {
                            ...
                            if (result32 !== null) {
                              ...
                              if (result33 !== null) {
                                var result34 = parse_FunctionBody();
                                if (result34 !== null) {
          ...
          var result22 = result21 !== null
            ? (function(p, name, body) {
                ...
                })(result21[0], result21[3], result21[11])
            : null;
          if (result22 !== null) {
          ...
          if (result20 !== null) {
            ...
            var result4 = parse_Pos();
            if (result4 !== null) {
              var result5 = parse_SetToken();
              if (result5 !== null) {
                var result6 = parse___();
                if (result6 !== null) {
                  var result7 = parse_PropertyName();
                  if (result7 !== null) {
                    var result8 = parse___();
                    if (result8 !== null) {
                      if (input.substr(pos, 1) === "(") {
            ...
            var result3 = result2 !== null
              ? (function(p, name, param, body) {
                  ...
                  })(result2[0], result2[3], result2[7], result2[13])
              : null;
            if (result3 !== null) {
              var result1 = result3;
            } else {
      ...
      function parse_FunctionParameter() {
        var cacheKey = 'FunctionParameter@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_FormalParameterList() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_FunctionParameter();
          if (result4 !== null) {
            var result5 = [];
            var savedPos2 = pos;
            var result7 = parse___();
            if (result7 !== null) {
              ...
              if (result8 !== null) {
                var result9 = parse___();
                if (result9 !== null) {
                  var result10 = parse_FunctionParameter();
                  if (result10 !== null) {
