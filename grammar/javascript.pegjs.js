    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        var result2 = result1 !== null
          ? (function(program) { return program; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_MultiLineComment() {
        ...
        var result2 = result1 !== null
          ? (function(chars) {return '/*' + chars.map(function(a){return a.join('');}).join('') + '*/';})(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
        ...
        if (result1 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                var result7 = parse_SingleLineComment();
                if (result7 !== null) {
      ...
      function parse_NodeComment() {
        ...
        var savedPos0 = pos;
        var result9 = parse_SingleLineCommentGroup();
        if (result9 !== null) {
          var result1 = result9;
        } else {
          var result8 = parse_MultiLineComment();
          if (result8 !== null) {
            var result1 = result8;
          } else {
            var result1 = null;;
      ...
      function parse_Identifier() {
        ...
        if (result3 !== null) {
          ...
          var savedReportMatchFailuresVar0 = reportMatchFailures;
          reportMatchFailures = false;
          var result6 = parse_ReservedWord();
          reportMatchFailures = savedReportMatchFailuresVar0;
          if (result6 === null) {
            var result4 = '';
          } else {
        ...
        var result2 = result1 !== null
          ? (function(p, name) { return {type: 'name', value: name, pos: p}; })(result1[0], result1[2])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_Literal() {
        ...
        var result13 = parse_NullLiteral();
        if (result13 !== null) {
          var result0 = result13;
        } else {
          var result12 = parse_BooleanLiteral();
          if (result12 !== null) {
            var result0 = result12;
          } else {
            var savedPos2 = pos;
            var savedPos3 = pos;
            var result10 = parse_Pos();
            if (result10 !== null) {
              var result11 = parse_NumericLiteral();
              if (result11 !== null) {
      ...
      function parse_NullLiteral() {
        ...
        var result2 = result1 !== null
          ? (function(p) { return { type: 'null', value: null, pos: p }; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_BooleanLiteral() {
        ...
        var savedPos2 = pos;
        var savedPos3 = pos;
        var result9 = parse_Pos();
        if (result9 !== null) {
          var result10 = parse_TrueToken();
          if (result10 !== null) {
        ...
        var result8 = result7 !== null
          ? (function(p) { return { type: 'boolean', value: true, pos: p }; })(result7[0])
          : null;
        if (result8 !== null) {
          var result6 = result8;
        } else {
        ...
        if (result6 !== null) {
          ...
          var savedPos0 = pos;
          var savedPos1 = pos;
          var result4 = parse_Pos();
          if (result4 !== null) {
            var result5 = parse_FalseToken();
            if (result5 !== null) {
              var result2 = [result4, result5];
            } else {
              var result2 = null;
          ...
          var result3 = result2 !== null
            ? (function(p) { return { type: 'boolean', value: false, pos: p }; })(result2[0])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
      ...
      function parse_RegularExpressionLiteral() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var result5 = parse_RegularExpressionBody();
            if (result5 !== null) {
              if (input.substr(pos, 1) === "/") {
                var result6 = "/";
                pos += 1;
              ...
              if (result6 !== null) {
                var result7 = parse_RegularExpressionFlags();
                if (result7 !== null) {
                  var result1 = [result3, result4, result5, result6, result7];
                } else {
                  var result1 = null;
      ...
      function parse_RegularExpressionBody() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_RegularExpressionFirstChar();
          if (result4 !== null) {
            var result5 = parse_RegularExpressionChars();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_PrimaryExpression() {
        ...
        var savedPos3 = pos;
        var savedPos4 = pos;
        var result18 = parse_Pos();
        if (result18 !== null) {
          var result19 = parse_ThisToken();
          if (result19 !== null) {
            var result16 = [result18, result19];
          } else {
            var result16 = null;
            pos = savedPos4;
          }
        ...
        var result17 = result16 !== null
          ? (function(p) { return { type: "this", value: "this", pos: p }; })(result16[0])
          : null;
        if (result17 !== null) {
        ...
        if (result15 !== null) {
          ...
          var result14 = result13 !== null
            ? (function(name) { return name; })(result13)
            : null;
          if (result14 !== null) {
            var result12 = result14;
          } else {
      ...
      function parse_ArrayLiteral() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              var result13 = parse_ElementList();
      ...
      function parse_PropertyNameAndValueList() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_CommentedPropertyAssignment();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse_CommentedPropertyAssignment();
              if (result8 !== null) {
      ...
      function parse_CommentedPropertyAssignment() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse___empty();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result7 = parse_Comment();
          if (result7 !== null) {
            var result8 = parse___empty();
            if (result8 !== null) {
              var result6 = [result7, result8];
            } else {
              var result6 = null;
          ...
          if (result4 !== null) {
            var result5 = parse_PropertyAssignment();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_PropertyAssignment() {
        ...
        if (result42 !== null) {
          var result43 = parse_Pos();
          if (result43 !== null) {
            var result44 = parse_PropertyName();
            if (result44 !== null) {
              var result45 = parse___();
              if (result45 !== null) {
                if (input.substr(pos, 1) === ":") {
                  var result46 = ":";
                  pos += 1;
                ...
                if (result46 !== null) {
                  var result47 = parse___();
                  if (result47 !== null) {
                    var result48 = parse_AssignmentExpression();
                    if (result48 !== null) {
                      var result40 = [result42, result43, result44, result45, result46, result47, result48];
                    } else {
                      var result40 = null;
                      pos = savedPos5;
                    }
        ...
        var result41 = result40 !== null
          ? (function(p, name, value) {
              ...
              })(result40[1], result40[2], result40[6])
          : null;
        if (result41 !== null) {
        ...
        if (result39 !== null) {
          ...
          if (result24 !== null) {
            var result25 = parse_Pos();
            if (result25 !== null) {
              var result26 = parse_GetToken();
              if (result26 !== null) {
                var result27 = parse___();
                if (result27 !== null) {
                  var result28 = parse_PropertyName();
                  if (result28 !== null) {
                          ...
                          if (result32 !== null) {
                            ...
                            if (result33 !== null) {
                              ...
                              if (result34 !== null) {
                                ...
                                if (result35 !== null) {
                                  var result36 = parse_FunctionBody();
                                  if (result36 !== null) {
                                    ...
                                    if (result37 !== null) {
                                      ...
                                      if (result38 !== null) {
                                        var result22 = [result24, result25, result26, result27, result28, result29, result30, result31, result32, result33, result34, result35, result36, result37, result38];
                                      } else {
                                        var result22 = null;
                                        pos = savedPos3;
                                      }
          ...
          var result23 = result22 !== null
            ? (function(p, name, body) {
                  return {
                    type: "get",
                    nodes: [{type: 'name', value: name}, body],
                    pos: p
                  };
                })(result22[1], result22[4], result22[12])
            : null;
          if (result23 !== null) {
          ...
          if (result21 !== null) {
            ...
            if (result4 !== null) {
              var result5 = parse_Pos();
              if (result5 !== null) {
                var result6 = parse_SetToken();
                if (result6 !== null) {
                  var result7 = parse___();
                  if (result7 !== null) {
                    var result8 = parse_PropertyName();
                    if (result8 !== null) {
                      var result9 = parse___();
                      if (result9 !== null) {
                        if (input.substr(pos, 1) === "(") {
                                ...
                                if (result14 !== null) {
                                  ...
                                  if (result15 !== null) {
                                    ...
                                    if (result16 !== null) {
                                      ...
                                      if (result17 !== null) {
                                        var result18 = parse_FunctionBody();
                                        if (result18 !== null) {
            ...
            var result3 = result2 !== null
              ? (function(p, name, param, body) {
                    return {
                      type: "set",
                      nodes: [{type: 'name', value: name}, param, body],
                      pos: p
                    };
                  })(result2[1], result2[4], result2[8], result2[14])
              : null;
            if (result3 !== null) {
              var result1 = result3;
            } else {
      ...
      function parse_MemberExpression() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result33 = parse_PrimaryExpression();
        if (result33 !== null) {
          var result3 = result33;
        } else {
          var result32 = parse_FunctionExpression();
          if (result32 !== null) {
            var result3 = result32;
          } else {
            var savedPos6 = pos;
            var savedPos7 = pos;
            var result26 = parse_Pos();
            if (result26 !== null) {
              var result27 = parse_NewToken();
              if (result27 !== null) {
            ...
            var result25 = result24 !== null
              ? (function(p, constructor, arguments) {
                        return {
                          type: "new",
                          nodes: [constructor, arguments],
                          pos: p
                        };
                      })(result24[0], result24[3], result24[5])
              : null;
            if (result25 !== null) {
        ...
        if (result3 !== null) {
              ...
              if (result19 !== null) {
                ...
                if (result20 !== null) {
                  ...
                  if (result21 !== null) {
                    ...
                    if (result22 !== null) {
                      var result15 = [result17, result18, result19, result20, result21, result22];
                    } else {
                      var result15 = null;
                      pos = savedPos5;
                    }
          ...
          var result16 = result15 !== null
            ? (function(selector, name) { return name; })(result15[1], result15[3])
            : null;
          if (result16 !== null) {
            var result14 = result16;
          } else {
          ...
          if (result14 !== null) {
            ...
            if (result9 !== null) {
              ...
              if (result10 !== null) {
                ...
                if (result11 !== null) {
                  var result12 = parse___();
                  if (result12 !== null) {
                    var result13 = parse_IdentifierName();
                    if (result13 !== null) {
            ...
            var result8 = result7 !== null
              ? (function(p, selector, name) { return {type: 'dot-name', value: name, p: pos}; })(result7[1], result7[2], result7[4])
              : null;
            if (result8 !== null) {
              var result6 = result8;
            } else {
      ...
      function parse_NewExpression() {
        ...
        var result8 = parse_MemberExpression();
        if (result8 !== null) {
          var result0 = result8;
        } else {
          var savedPos0 = pos;
      ...
      function parse_CallExpression() {
        ...
        var savedPos8 = pos;
        var savedPos9 = pos;
        var result32 = parse_Pos();
        if (result32 !== null) {
          var result33 = parse_MemberExpression();
          if (result33 !== null) {
            var result34 = parse___();
            if (result34 !== null) {
              var result35 = parse_Arguments();
              if (result35 !== null) {
                var result30 = [result32, result33, result34, result35];
              } else {
                var result30 = null;
                pos = savedPos9;
              }
        ...
        var result31 = result30 !== null
          ? (function(p, name, arguments) {
                  return {
                    type: "call",
                    nodes: [name, arguments],
                    pos: p
                  };
                })(result30[0], result30[1], result30[3])
          : null;
        if (result31 !== null) {
      ...
      function parse_Arguments() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              var result9 = parse_ArgumentList();
      ...
      function parse_PostfixExpression() {
        ...
        var result5 = parse_Pos();
        if (result5 !== null) {
          var result6 = parse_LeftHandSideExpression();
          if (result6 !== null) {
            var result7 = parse__();
            if (result7 !== null) {
              var result8 = parse_PostfixOperator();
              if (result8 !== null) {
        ...
        var result4 = result3 !== null
          ? (function(p, expression, operator) {
                return {
                  type: "postfix",
                  nodes: [operator, expression],
                  pos: p
                };
              })(result3[0], result3[1], result3[3])
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_UnaryExpression() {
        ...
        var result8 = parse_PostfixExpression();
        if (result8 !== null) {
          var result0 = result8;
        } else {
          var savedPos0 = pos;
          ...
          var result4 = parse_Pos();
          if (result4 !== null) {
            var result5 = parse_UnaryOperator();
            if (result5 !== null) {
              var result6 = parse___();
              if (result6 !== null) {
          ...
          var result3 = result2 !== null
            ? (function(p, operator, expression) {
                  return {
                    type: "unary",
                    nodes: [operator, expression],
                    pos: p
      ...
      function parse_UnaryOperator() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result13 = parse_DeleteToken();
          if (result13 !== null) {
            var result4 = result13;
          } else {
            var result12 = parse_VoidToken();
            if (result12 !== null) {
              var result4 = result12;
            } else {
              var result11 = parse_TypeofToken();
              if (result11 !== null) {
      ...
      function parse_MultiplicativeOperator() {
        ...
        var result2 = result1 !== null
          ? (function(p, operator) { return {type: 'operator', value: operator, pos: p}; })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_AdditiveOperator() {
        ...
        var result12 = result11 !== null
          ? (function(p) { return {type: 'operator', value: "+", pos: p}; })(result11[0])
          : null;
        if (result12 !== null) {
        ...
        if (result10 !== null) {
          ...
          var result3 = result2 !== null
            ? (function(p) { return {type: 'operator', value: "-", pos: p}; })(result2[0])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
            ...
            if (result9 !== null) {
              ...
              if (result8 !== null) {
                ...
                if (result7 !== null) {
                  ...
                  var result6 = parse_InstanceofToken();
                  if (result6 !== null) {
                    var result4 = result6;
                  } else {
                    var result5 = parse_InToken();
                    if (result5 !== null) {
                      var result4 = result5;
                    } else {
                      var result4 = null;;
            ...
            if (result8 !== null) {
              ...
              if (result7 !== null) {
                ...
                if (result6 !== null) {
                  ...
                  var result5 = parse_InstanceofToken();
                  if (result5 !== null) {
                    var result4 = result5;
                  } else {
                    var result4 = null;;
      ...
      function parse_BitwiseANDOperator() {
        ...
        var result2 = result1 !== null
          ? (function(p) { return {type: 'operator', value: "&", pos: p}; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_ConditionalExpression() {
                  ...
                  if (result10 !== null) {
                    ...
                    if (result11 !== null) {
                      ...
                      if (result12 !== null) {
                        var result13 = parse___();
                        if (result13 !== null) {
                          var result14 = parse_AssignmentExpression();
                          if (result14 !== null) {
                            var result3 = [result5, result6, result7, result8, result9, result10, result11, result12, result13, result14];
                          } else {
                            var result3 = null;
                            pos = savedPos1;
                          }
        ...
        var result4 = result3 !== null
          ? (function(p, condition, trueExpression, falseExpression) {
                return {
                  type: "conditional",
                  nodes: [condition, trueExpression, falseExpression],
                  pos: p
                };
              })(result3[0], result3[1], result3[5], result3[9])
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_ConditionalExpressionNoIn() {
        ...
        var result5 = parse_Pos();
        if (result5 !== null) {
          var result6 = parse_LogicalORExpressionNoIn();
          if (result6 !== null) {
            var result7 = parse___();
            if (result7 !== null) {
              if (input.substr(pos, 1) === "?") {
              ...
              if (result8 !== null) {
                var result9 = parse___();
                if (result9 !== null) {
                  var result10 = parse_AssignmentExpressionNoIn();
                  if (result10 !== null) {
                    var result11 = parse___();
                    if (result11 !== null) {
                      if (input.substr(pos, 1) === ":") {
                      ...
                      if (result12 !== null) {
                        var result13 = parse___();
                        if (result13 !== null) {
                          var result14 = parse_AssignmentExpressionNoIn();
                          if (result14 !== null) {
                            var result3 = [result5, result6, result7, result8, result9, result10, result11, result12, result13, result14];
                          } else {
                            var result3 = null;
      ...
      function parse_AssignmentExpression() {
        ...
        if (result5 !== null) {
          ...
          if (result6 !== null) {
            var result7 = parse___();
            if (result7 !== null) {
              var result8 = parse_AssignmentOperator();
              if (result8 !== null) {
                var result9 = parse___();
                if (result9 !== null) {
                  var result10 = parse_AssignmentExpression();
        ...
        var result4 = result3 !== null
          ? (function(p, left, operator, right) {
                return {
                  type: "assign",
                  nodes: [operator, left, right],
                  pos: p
                };
              })(result3[0], result3[1], result3[3], result3[5])
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_StatementList() {
        ...
        if (result3 !== null) {
          var result4 = [];
          var result5 = parse_CommentedStatement();
          while (result5 !== null) {
            result4.push(result5);
            var result5 = parse_CommentedStatement();
          }
      ...
      function parse_VariableStatement() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result9 = parse_VarToken();
          if (result9 !== null) {
            var result4 = result9;
          } else {
            var result8 = parse_ConstToken();
            if (result8 !== null) {
              var result4 = result8;
            } else {
              var result4 = null;;
          ...
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              var result6 = parse_VariableDeclarationList();
              if (result6 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(p, varOrConst, declarations) {
                var type = "vars";
      ...
      function parse_VariableDeclaration() {
        ...
        var result2 = result1 !== null
          ? (function(p, comments, name, value) {
                return addComments({
                  type: "var",
                  nodes: [name, value !== "" ? value : undefinedNode(p)],
                  pos: p
                }, comments);
              })(result1[0], result1[2], result1[3], result1[4])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_EmptyStatement() {
        ...
        var result2 = result1 !== null
          ? (function(p) { return { type: "empty", pos: p }; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_WhileStatement() {
        ...
        var result2 = result1 !== null
          ? (function(p, condition, statement) {
                return {
                  type: "while",
                  nodes: [condition, statement],
                  pos: p
                };
              })(result1[0], result1[5], result1[9])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_ForStatement() {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  ...
                  if (result25 !== null) {
                    ...
                    var result24 = parse_ExpressionNoIn();
                  ...
                  if (result8 !== null) {
                    ...
                    if (result9 !== null) {
                      ...
                      if (result10 !== null) {
                        var result11 = parse___();
                        if (result11 !== null) {
                          var result22 = parse_Expression();
                          var result12 = result22 !== null ? result22 : '';
                          if (result12 !== null) {
                            var result13 = parse___();
                            if (result13 !== null) {
                              if (input.substr(pos, 1) === ";") {
                              ...
                              if (result14 !== null) {
                                ...
                                if (result15 !== null) {
                                  var result21 = parse_Expression();
                                  var result16 = result21 !== null ? result21 : '';
                                  if (result16 !== null) {
                                    var result17 = parse___();
                                    if (result17 !== null) {
                                      if (input.substr(pos, 1) === ")") {
        ...
        var result2 = result1 !== null
          ? (function(p, initializer, test, counter, statement) {
                return {
                  type: "for",
                  nodes: [
              ...
              })(result1[0], result1[5], result1[9], result1[13], result1[17])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_ForInStatement() {
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  var savedPos2 = pos;
                  var savedPos3 = pos;
                  var result21 = parse_VarToken();
                  if (result21 !== null) {
                    var result22 = parse___();
                    if (result22 !== null) {
                      var result23 = parse_VariableDeclarationNoIn();
                      if (result23 !== null) {
                  ...
                  var result20 = result19 !== null
                    ? (function(declaration) { return declaration; })(result19[2])
                    : null;
                  if (result20 !== null) {
                  ...
                  if (result18 !== null) {
                    ...
                    var result17 = parse_LeftHandSideExpression();
                    if (result17 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(p, iterator, collection, statement) {
                return {
                  type: 'for-in',
                  nodes: [iterator, collection, statement],
                  pos: p
                }
              })(result1[0], result1[5], result1[9], result1[13])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_ContinueStatement() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_ContinueToken();
          if (result4 !== null) {
            var result5 = parse__();
            if (result5 !== null) {
              var savedPos3 = pos;
              ...
              var result12 = result11 !== null
                ? (function(identifier) { return identifier; })(result11[0])
                : null;
              if (result12 !== null) {
                var result10 = result12;
              } else {
              ...
              if (result10 !== null) {
                ...
                var savedPos2 = pos;
                var result8 = parse_EOSNoLineTerminator();
                var result9 = result8 !== null
                  ? (function() { return ""; })()
                  : null;
                if (result9 !== null) {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result5 !== null) {
              ...
              var result12 = result11 !== null
                ? (function(expression) { return expression; })(result11[0])
                : null;
              if (result12 !== null) {
                var result10 = result12;
              } else {
      ...
      function parse_WithStatement() {
        ...
        var result2 = result1 !== null
          ? (function(p, environment, statement) {
                return {
                  type: "with",
      ...
      function parse_CaseBlock() {
          ...
          if (result4 !== null) {
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                var result11 = parse___();
                if (result11 !== null) {
                  var result12 = parse_DefaultClause();
                  if (result12 !== null) {
                    var result13 = parse___();
                    if (result13 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(p, before, defaultAndAfter) {
      ...
      function parse_CaseClause() {
        ...
        var result2 = result1 !== null
          ? (function(p, selector, statements) {
                return {
                  type: "case",
                  nodes: [selector, nodeList(statements, p)],
                  pos: p
                };
              })(result1[0], result1[3], result1[6])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_DefaultClause() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_DefaultToken();
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              if (input.substr(pos, 1) === ":") {
      ...
      function parse_LabelledStatement() {
        ...
        var result2 = result1 !== null
          ? (function(p, label, statement) {
                return {
                  type: "labeled-statement",
                  nodes: [label, statement],
                  pos: p
                };
              })(result1[0], result1[1], result1[5])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_TryStatement() {
        ...
        var savedPos4 = pos;
        var savedPos5 = pos;
        var result22 = parse_Pos();
        if (result22 !== null) {
          var result23 = parse_TryToken();
          if (result23 !== null) {
            var result24 = parse___();
            if (result24 !== null) {
              var result25 = parse_Block();
              if (result25 !== null) {
                var result26 = parse___();
                if (result26 !== null) {
                  var result27 = parse_Catch();
                  if (result27 !== null) {
                    var result28 = parse___();
                    if (result28 !== null) {
                      var result29 = parse_Finally();
                      if (result29 !== null) {
        ...
        var result21 = result20 !== null
          ? (function(p, block, catch_, finally_) {
                return {
                  type: "try",
                  nodes: [block, catch_, finally_],
                  pos: p
                };
              })(result20[0], result20[3], result20[5], result20[7])
          : null;
        if (result21 !== null) {
        ...
        if (result19 !== null) {
          ...
          var result12 = result11 !== null
            ? (function(p, block, catch_) {
                  return {
                    type: "try",
                    nodes: [block, catch_, undefinedNode(p)],
                    pos: p
                  };
                })(result11[0], result11[3], result11[5])
            : null;
          if (result12 !== null) {
            var result10 = result12;
          } else {
      ...
      function parse_Finally() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_FinallyToken();
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
      ...
      function parse_DebuggerStatement() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_DebuggerToken();
          if (result4 !== null) {
            var result5 = parse_EOS();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
        ...
        var result2 = result1 !== null
          ? (function(p) { return { type: "debug", pos: p }; })(result1[0])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_FunctionDeclaration() {
        ...
        var result3 = parse_Pos();
        if (result3 !== null) {
          var result4 = parse_FunctionToken();
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              var result6 = parse_Identifier();
                  ...
                  if (result8 !== null) {
                    ...
                    if (result9 !== null) {
                      ...
                      if (result10 !== null) {
                        ...
                        var result11 = result19 !== null ? result19 : '';
                        if (result11 !== null) {
                          var result12 = parse___();
                          if (result12 !== null) {
                            if (input.substr(pos, 1) === ")") {
        ...
        var result2 = result1 !== null
          ? (function(p, name, pp, params, body) {
                return {
                  type: 'define-function',
                  nodes: [name, nodeList(params, pp, 'parameters'), body],
                  pos: p
                };
              })(result1[0], result1[3], result1[7], result1[8], result1[13])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_FunctionBody() {
        ...
        var result2 = result1 !== null
          ? (function(p, elements) { return nodeList(elements, p); })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_SourceElements() {
        ...
        if (result3 !== null) {
          var result4 = [];
          var result5 = parse_SourceElement();
          while (result5 !== null) {
            result4.push(result5);
            var result5 = parse_SourceElement();
          }
