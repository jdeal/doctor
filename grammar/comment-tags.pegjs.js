  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "AnyTag": parse_AnyTag,
        "AtDescriptionSpan": parse_AtDescriptionSpan,
        "Blank": parse_Blank,
        ...
        "DescriptionTag": parse_DescriptionTag,
        "DetachedTypeList": parse_DetachedTypeList,
        "ExampleTag": parse_ExampleTag,
        "ExtendsTag": parse_ExtendsTag,
        "Identifier": parse_Identifier,
        "IdentifierChar": parse_IdentifierChar,
        "IdentifierStart": parse_IdentifierStart,
        "KnownTag": parse_KnownTag,
        ...
        "Nd": parse_Nd,
        "Nl": parse_Nl,
        "NoAtDescriptionSpan": parse_NoAtDescriptionSpan,
      ...
      function parse_start() {
        ...
        var result2 = result1 !== null
          ? (function(types, description, tags) {
              var tags = tags === '' ? [] : tags;
              if (description !== '') {
      ...
      function parse_DescriptionSpan() {
        ...
        var result2 = parse_AtDescriptionSpan();
        if (result2 !== null) {
          var result0 = result2;
        } else {
          var result1 = parse_NoAtDescriptionSpan();
          if (result1 !== null) {
            var result0 = result1;
          } else {
            var result0 = null;;
      ...
      function parse_AtDescriptionSpan() {
        var cacheKey = 'AtDescriptionSpan@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_NoAtDescriptionSpan() {
        var cacheKey = 'NoAtDescriptionSpan@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_AnyTag() {
        var cacheKey = 'AnyTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_KnownTag() {
        var cacheKey = 'KnownTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result3 = parse___();
        if (result3 !== null) {
          var result17 = parse_DescriptionTag();
          if (result17 !== null) {
            var result4 = result17;
          } else {
            var result16 = parse_ParamTag();
            if (result16 !== null) {
              var result4 = result16;
            } else {
              var result15 = parse_ReturnTag();
              if (result15 !== null) {
                var result4 = result15;
              } else {
                var result14 = parse_ClassTag();
                if (result14 !== null) {
                  var result4 = result14;
                } else {
                  var result13 = parse_ConstructorTag();
                  if (result13 !== null) {
                    var result4 = result13;
                  } else {
                    var result12 = parse_PropertyTag();
                    if (result12 !== null) {
                      var result4 = result12;
                    } else {
                      var result11 = parse_ExampleTag();
                      if (result11 !== null) {
                        var result4 = result11;
                      } else {
                        var result10 = parse_VisibilityTag();
                        if (result10 !== null) {
                          var result4 = result10;
                        } else {
                          var result9 = parse_AbstractTag();
                          if (result9 !== null) {
                            var result4 = result9;
                          } else {
                            var result8 = parse_ExtendsTag();
                            if (result8 !== null) {
                              var result4 = result8;
                            } else {
                              var result7 = parse_SignatureTag();
                              if (result7 !== null) {
                                var result4 = result7;
                              } else {
                                var result6 = parse_CopyTag();
                                if (result6 !== null) {
                                  var result4 = result6;
                                } else {
                                  var result5 = parse_UnknownTag();
                                  if (result5 !== null) {
                                    var result4 = result5;
                                  } else {
                                    var result4 = null;;
      ...
      function parse_UnknownTag() {
        var cacheKey = 'UnknownTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_DescriptionTag() {
        var cacheKey = 'DescriptionTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        if (input.substr(pos, 12) === "@description") {
          var result3 = "@description";
          pos += 12;
        } else {
          var result3 = null;
          if (reportMatchFailures) {
      ...
      function parse_ParamTag() {
        ...
        if (result3 !== null) {
          var result30 = parse_TypeList();
          var result4 = result30 !== null ? result30 : '';
          if (result4 !== null) {
            var result29 = parse_Blank();
            if (result29 !== null) {
              var result5 = [];
              while (result29 !== null) {
                result5.push(result29);
                var result29 = parse_Blank();
              }
            } else {
              var result5 = null;
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  var result8 = [];
                  var result24 = parse_Blank();
                  while (result24 !== null) {
                    result8.push(result24);
                    var result24 = parse_Blank();
                  }
                  if (result8 !== null) {
                    var result23 = parse_PropertyChain();
                    var result9 = result23 !== null ? result23 : '';
                    if (result9 !== null) {
                      var result22 = parse_DefaultValue();
        ...
        var result2 = result1 !== null
          ? (function(types, lbracket, name, prop, defaultValue, rbracket, text) {
              var tag = {
                name: 'param',
                value: {
                  name: name,
              ...
              return tag;
            })(result1[1], result1[3], result1[4], result1[6], result1[7], result1[8], result1[11])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_VisibilityTag() {
        var cacheKey = 'VisibilityTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_ExtendsTag() {
        var cacheKey = 'ExtendsTag@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_StartTypeList() {
        var cacheKey = 'StartTypeList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var result3 = parse___();
        if (result3 !== null) {
          var result4 = parse_DetachedTypeList();
          if (result4 !== null) {
            var result1 = [result3, result4];
          } else {
            var result1 = null;
      ...
      function parse_DetachedTypeList() {
        var cacheKey = 'DetachedTypeList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result19 !== null) {
              var result21 = parse_TypeParameters();
              var result20 = result21 !== null ? result21 : '';
              if (result20 !== null) {
                var result5 = [result19, result20];
              } else {
                var result5 = null;
                pos = savedPos3;
              }
              ...
              if (result6 !== null) {
                ...
                if (result12 !== null) {
                  ...
                  if (result13 !== null) {
                    ...
                    if (result14 !== null) {
                      var result16 = parse_TypeParameters();
      ...
      function parse_TypeParameters() {
        var cacheKey = 'TypeParameters@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result3 !== null) {
          var result6 = parse_TypeParameterList();
      ...
      function parse_TypeParameterList() {
        var cacheKey = 'TypeParameterList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
