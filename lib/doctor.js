...
function examine(options, cb) {
  ...
  async.waterfall([
    ...
    function copyView(cb) {
      ...
      async.forEach(options.view, eachView, cb);
    },
    function getAst(cb) {
